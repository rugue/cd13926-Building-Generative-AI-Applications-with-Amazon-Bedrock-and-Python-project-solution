...
if __name__ == "__main__":
    # Folder path
    folder_path = folder_path = os.path.join(os.path.dirname(__file__), "spec-sheets")
    
    # S3 bucket name
    bucket_name = "udacity-bedrock-kb-769078151975"  # Replace with your actual bucket name
